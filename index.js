const apikey = "f0943dcf5e783a54d4ad833a8844ce62";
...
function searchMovieTrailer(movieName, iframId) {
    ...
    .then(res => {
        ...
        const div = document.createElement('div');
        div.innerHTML = `<iframe width="245px" height="150px" src="https://www.youtube.com/embed/${bestResult.id.videoId}?autoplay=1&controls=0" height="500px" width="500px"></iframe>`
